...
MCAno.simu.fn <- function(phi, p.true, ncohort=12, init.level=1, 
    ...
    for (i in 1:ncohort){
        ...
        pss <- lapply(1:ndose, function(k)gen.mu.rand.no(k, J=add.args$J, K=ndose, phi=phi, delta=add.args$delta))
